  ...
  <div id="wrapper" >
    ...
    <header  style="background-color: black">
        ...
        <div class="container">
          <div class="row">
           ...
           <div class="span6">
              ...
              <li><a href="https://www.linkedin.com/in/glory-nwa-8a2a27103/" data-placement="bottom" title="Linkedin"><i class="icon-linkedin icon-white" target="_blank"></i></a></li>
                ...
                <li><a  href="https://api.whatsapp.com/send?phone=+2347068057873" data-placement="bottom" title="Whatsapp"><img src="img/whatss.PNG" style="width:20px; border-radius:8px"target="_blank"></a></li>
              </ul>
      ...
      <div class="container">
        ...
        Digital Problems Solution Partner  -- Lets Take Your Business to the Next Level Today >>></marquee>
